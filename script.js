window.addEventListener('load',function(){
    ...
    class Egg {
        ...
        update(deltaTime){
            ...
            game.obstacles, ...this.game.enemies, this.game.hatchlings];
    ...
    class Enemy {
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.spriteX, this.
                spriteY, this.width, this.height);
                if(this.game.debug){
                    context.beginPath();
                    context.arc(this.collisionX,this.collisionY,this.collisionRadius,
    ...
    class Game {
        constructor(canvas){
            ...
            this.gameObjects = [];
            this.score = 0;
            this.winningScore = 30; // for win need 30 score
            this.gameOver = false;
        ...
        render(context,deltaTime){ // deltaTime для відтворення методу
            ...
            if(this.eggTimer > this.eggInterval && this.eggs
                .length < this.maxEggs && !this.gameOver){
                this.addEgg();
                this.eggTimer = 0;
            } else {
            ...
            if(this.score >= this.winningScore) {
                ...
                context.font = '130px Freeman';
                context.fillText(message1, this.width * 0.5, this.height * 0.5 - 20);
                context.font = '40px Freeman';
                context.fillText(message2, this.width * 0.5, this.height * 0.5 + 30)
                context.fillText(`Final score ${this.score}. Press 'R' to butt heads againg!`, this.width * 0.5, this.height * 0.5 + 80)
                context.restore();
            }
        }
        checkCollision(a, b){
